...
<template>
  <main class="max-w-xl mx-auto px-6 py-8 text-gray-800 font-sans">
    ...
    <!-- 总开关 -->
    <section class="mb-8">
      <label class="flex items-center justify-between p-4 rounded-lg border cursor-pointer" :class="settings.enabled ? 'border-teal-600 bg-teal-50' : 'border-gray-300 bg-gray-50'">
        <div>
        ...
        <button
          ...
          :class="settings.enabled ? 'bg-teal-600' : 'bg-gray-300'"
    ...
    <section class="mb-8">
      ...
      >
        ...
        <input
          ...
          :class="isValidRegex(p) ? 'border-gray-300 focus:border-teal-600' : 'border-red-400 bg-red-50'"
        >
        <button
      ...
      <div class="flex items-center gap-2 mt-3">
        <input
          ...
          class="flex-1 border border-gray-300 rounded px-2 py-1.5 text-sm font-mono focus:outline-none focus:border-teal-600"
          @keydown.enter="addPattern"
        >
        <button
          class="w-7 h-7 rounded-full bg-teal-600 text-white hover:bg-teal-700 font-bold shrink-0"
          title="添加"
          @click="addPattern"
        >
          +
    ...
    <section>
      ...
      <div
        ...
        :class="recording ? 'border-teal-600 bg-teal-50 text-teal-700' : 'border-gray-300'"
